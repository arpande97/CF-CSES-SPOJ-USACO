...
public class Schedule {
    ...
    /* 
     * - for each group, you have to give 6 classrooms (may be same for different course) and maximize the jumps in those 6 classes
     * - and do this for each group
     * - number of classrooms is greater than no of groups and hence you always have a way to distribute them
     * - make sure while assigning for a class k out of 6 classes, no two groups get the same classroom
     * - is this dp? becuase you are maximizing -> what is the state
     * - at each classroom, you are providing a subset of available classes (bitmask? no becuase number of classrooms is too high)
     * - at each point I can make a greedy choice?
     */
