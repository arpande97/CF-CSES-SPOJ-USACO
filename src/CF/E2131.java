...
public class E2131 {
    ...
    /*
     * - each index can be transformed once: ai = a(i) ^ a(i + 1)
     * - so it matters when you do it
     * - once an index is changed, it can affect all the nums before it but not after
