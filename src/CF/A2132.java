...
public class A2132 {
    ...
    private static void solve() throws IOException {
        ...
        String b = ns();
        String dist = ns();
        //a stays in the middle
        //vlad to beginning of string, dima to the end;
        StringBuilder vlad = new StringBuilder(), dima = new StringBuilder();
        for (int i = 0; i < n; i++) {
            if (dist.charAt(i) == 'V')
                vlad.append(b.charAt(i));
            else    
                dima.append(b.charAt(i));
        }
        StringBuilder og = new StringBuilder(a);
        StringBuilder res = new StringBuilder();
        res.append(vlad.reverse()).append(og).append(dima);
