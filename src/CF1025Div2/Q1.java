...
public class Q1 {
    ...
    /*
     * the thing to note here is if there is a 0, that means it lost to both left and right, so 0 should always be surround by 1 on both sides
     * other than that, if there is even a single zero, that means any arr is accepted
     */
