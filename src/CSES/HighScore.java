...
public class HighScore {
    ...
    /*
     * - should not really care about the positive cycles on the paths that don't lead to node n - 1
     * - only +ve cycles on a node on the path of n - 1 is problematic
     * - maybe keep track of nodes that are part of the cycle on a path to n - 1
     */
