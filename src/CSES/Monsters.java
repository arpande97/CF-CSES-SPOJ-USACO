...
public class Monsters {
    ...
    static final int IMAX = Integer.MAX_VALUE, IMIN = Integer.MIN_VALUE;
    ...
    private static void solve() throws IOException {
        ...
        //starting from all the monsters start a multisource bfs and keep relaxing to shorter distances
        while (!q.isEmpty()) {
            int[] node = q.poll();
    ...
    private static boolean impossible(int nx, int ny) {
        return nx < 0 || nx >= m || ny < 0 || ny >= n || grid[nx][ny] == '#';
    }
