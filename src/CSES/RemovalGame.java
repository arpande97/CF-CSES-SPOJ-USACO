...
public class RemovalGame {
    ...
    private static void solve() throws IOException {
        ...
        long ans = (dp[0][n - 1] + total)/2;
        println(ans);
    }
    //1 2 3 4 -> f takes 4 = 123 -> s can take 1 or 3
    // private static long solve(int l, int r, int[] arr) {
    //     if (l == r)
    //         return arr[l];
    //     if (dp[l][r] != null)
    //         return dp[l][r];
    //     long c1 = arr[l] - solve(l + 1, r, arr);
    //     long c2 = arr[r] - solve(l, r - 1, arr);
