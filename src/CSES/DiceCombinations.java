...
public class DiceCombinations {
    ...
    /*
     * - recursive in this case TLEs
     * - recursive to bottom up is easy
     * - thought process to directly jump to bottom-up
     * - ways to generate a sum i is equal to how many ways you can get i - 1, i - 2, i - 3, i - 4, i - 5, i - 6 and then add them
     */
